...
import type { PortfolioView } from '@tickr/shared-types';

/**
 * Build the full `PortfolioView` for a portfolio: positions valued at the
 * latest `price_bar.close`, equity, buying power, and last snapshot time.
 * Shared by `GET /portfolios/:id` and the WS `portfolio.updated` publish hook.
