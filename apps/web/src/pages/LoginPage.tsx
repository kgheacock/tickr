...
// TODO(TODO-20 item 2): replace with the Google-account-gated request-access
// form URL (Google Forms / Tally with sign-in gate) once Keith creates it.
...
const REQUEST_ACCESS_URL = 'https://forms.gle/REPLACE_WITH_REAL_FORM_ID';
    ...
    <main className={styles.page}>
      <div className={styles.hero}>
        ...
        <p className={styles.tagline}>
          Sign in to explore historical price data and backtest trading
          strategies against the S&amp;P 500 universe.
        </p>
...
// Inline SVGs keep the auth screen dependency-free, consistent with the
